...
func (h *Handler) ListCustomer(ctx *fiber.Ctx) error {
	var params ListCustomerRequest
	...
	resp, count, err := h.service.ListCustomer(ctx, params)
	if err != nil {
...
func (h *Handler) CreateCustomer(ctx *fiber.Ctx) error {
	...
	err := h.service.CreateCustomer(ctx, body)
	if err != nil {
		return errors.HandleError(ctx, err)
	}
...
func (h *Handler) UpdateCustomer(ctx *fiber.Ctx) error {
	...
	err := h.service.UpdateCustomer(ctx, id, body)
	if err != nil {
		return errors.HandleError(ctx, err)
	}
...
func (h *Handler) DeleteCustomer(ctx *fiber.Ctx) error {
	...
	err := h.service.DeleteCustomer(ctx, id)
	if err != nil {
		return errors.HandleError(ctx, err)
	}
