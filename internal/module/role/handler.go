...
func (h *Handler) ListRole(ctx *fiber.Ctx) error {
	var params ListRoleRequest
	...
	resp, count, err := h.service.ListRole(ctx, params)
	if err != nil {
...
func (h *Handler) CreateRole(ctx *fiber.Ctx) error {
	...
	err := h.service.CreateRole(ctx, body)
	if err != nil {
		return errors.HandleError(ctx, err)
	}
...
func (h *Handler) UpdateRole(ctx *fiber.Ctx) error {
	...
	err := h.service.UpdateRole(ctx, id, body)
	if err != nil {
		return errors.HandleError(ctx, err)
	}
